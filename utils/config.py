...
def parse_args(config_path=None):
    ...
    parser.add("--vqvae_whole_path", default="", type=str)
    ...
    parser.add("--stft_rep", default=None, type=str)
    parser.add("--w2c_rep", default=None, type=str)
    ...
    parser.add("--raw_audio_rep", default=None, type=str)
